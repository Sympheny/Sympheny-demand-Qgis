...
SOURCES = \
	__init__.py \
	Sympheny_demands.py Sympheny_demands_dialog.py

PLUGINNAME = Sympheny_demands

PY_FILES = \
	__init__.py \
	Sympheny_demands.py Sympheny_demands_dialog.py

UI_FILES = Sympheny_demands_dialog_base.ui
...
QGISDIR=C:\Users\carlo_wa5x\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
